      ...
      <Contents>
        <Content>
          ...
          <InnerUl>
            ...
            <InnerLi>職探し: 近畿圏と大阪をメインに色々見てます。</InnerLi>

            <InnerLi>
              My Accounts:
              <Link href="https://github.com/NakaiKazuki" target="_blank"><GitHubIcon />GitHub</Link>
              <Link href="https://twitter.com/k_kyube" target="_blank"><TwitterIcon color="primary" />Twitter</Link>
            </InnerLi>
          ...
          <Paragraph>
            相手の立場になって物事を考えることができることです。<br />
            この長所が活かされたのは現在の職場で新しく同僚が出来た時の事があげられます。<br />
            元々私自身が人に話しかけに行くことが得意ではなかったのですが、私が働き始めたときは覚えることが多くわからないことだらけで不安だった経験があるので、<br />
            少しでも相手が困ってそうだなと感じたらどこがわからないのかを自分から聞きに行くことを心がけました。<br />
            結果としてその後のコミュニケーションも取りやすくわからないことは積極的に聞いてもらえるようになりました。<br />
            なので現在では同僚お客さんどちらも困ってそうな雰囲気を感じたら自分から話しかけに行くようにしています。<br />
            この経験から、相手のことを考えて自分から積極的に動くことが良い人間関係の構築に繋がり働きやすい環境を作れることを学びました。
          </Paragraph>
          <ContentTitle>エンジニア志望動機:</ContentTitle>
          <Paragraph>
            元々 PC でゲームをすることが好きで何か手に職をつけたいと考えたときに、一番身近にある PC を利用したものにしようと考えエンジニアを目指し独学を始めました。<br />
            勉強をし始めたときは何度もエラーになったことで挫けましたが、それでも進めていくうちにエラーの対処にも慣れ今では一人で web アプリの開発が行えるようになりました。<br />
          ...
          <Paragraph>
            現在はフロントエンドについて深掘りをしたいと考えているので今後はHTMLCSS関連やJacaScriptについての引き出しを増やしながら、コード自体をもっと綺麗書きつつSEOとデザインついての勉強をして見やすく使いやすいサイト作れるようなりたいと考えています。<br />
          ...
          <Paragraph>
            ...
            将来的にはアイデアを形にできるだけの技術を身に着け、移住希望の方の意見を聞きながら少しでも地方問題を解決できる助けになるものを作りたいと思っています。<br />
          </Paragraph>
        </Content>
      </Contents>
    </Fragment>
    ...
    <Fragment>
      ...
      <Contents>
        <Content>
          ...
          <Paragraph>
            ちょっとした思いつきやメモなどを200 文字以内の日記として記録するアプリケーションです。<br />
        ...
        <Content>
          ...
          <Paragraph>
            テキストでの表示だけじゃなくアイコンも使用することで直観的に理解できるようにしました。<br />
            その一環としてメニューバーなどのアイコンや配置に関しても Twitter や YouTube などで設置されてる場所を参考に設置しました。<br />
        ...
        <Content>
          ...
          <Paragraph>
            ...
            といっても足りない要素だらけで他にも苦労したことが多々あって無限にやることが沸いてきますが(笑)それも含めて楽しいのでこれからも頑張りたいです！
          </Paragraph>
        </Content>
      </Contents>
    </Fragment>
