...
export const SignUpFormInfo = (errors: any, control: any, apiErrors: any): Array<object> => {
  return [
    {
...
export const LoginFormInfo = (errors: any, control: any, apiErrors: any): Array<object> => {
  return [
    {
      errorsProperty: errors.email,
      control: control,
