  ...
  describe('Form欄', () => {
    ...
    describe('Form入力欄', () => {
      ...
      it('Apiエラーメッセージ', () => {
        ...
        // ユーザが送信ボタンをクリック
        userEvent.click(screen.getByTestId('signUpSubmit'));
    ...
    describe('送信ボタン',() => {
      ...
      it('送信状況に応じてボタンの要素が変化 Status200', async() => {
        ...
        expect(signUpSubmit).not.toBeDisabled();

        // ユーザが送信ボタンをクリック
        userEvent.click(signUpSubmit);

        // 送信完了
        await waitFor(() => expect(signUpSubmit).toHaveTextContent('送信完了!'));
        await waitFor(() => expect(signUpSubmit).toBeDisabled());
      })
      ...
      it('送信状況に応じてボタンの要素が変化 Status401', async() => {
        ...
        await waitFor(() => expect(signUpSubmit).toHaveTextContent('SignUp!'));
        await waitFor(() => expect(signUpSubmit).not.toBeDisabled());
      })
    })
  })
